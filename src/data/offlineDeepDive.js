...
const BRAND_PROFILES = {
  ...
  sainsburys: {
    ...
    vendors: ["Kenpark Bangladesh Apparel Pvt. Ltd. (Bangladesh)", "Tefron Europe SRL (Romania)", "DATSA TEXTIL SRL (Romania)", "FB DIS TICARET AS (Turkey)", "Taneks Giyim Tekstil (Turkey)"],
    vendorsByCategory: {
  ...
  next: {
    ...
    vendors: ["Ananta Apparels Ltd (Bangladesh)", "Square Fashions Ltd (Bangladesh)", "Tusuka Trousers & Jeans Ltd (Bangladesh)", "Utah Fashions Ltd (Bangladesh)", "Fakir Apparels Ltd (Bangladesh)", "Echotex Ltd (Bangladesh)", "AKM Knit Wear Limited (Bangladesh)"],
    vendorsByCategory: {
