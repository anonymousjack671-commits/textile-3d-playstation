...
const BRAND_PROFILES = {
  ...
  sainsburys: {
    ...
    vendorsByCategory: {
      ...
      "School Uniform":         ["Echotex Ltd (Bangladesh) — jersey school polos/sweatshirts", "Kenpark Bangladesh Apparel Pvt. Ltd. (K-3) (Bangladesh) — woven school shirts/trousers", "SOUTH EAST TEXTILES (PVT.) LIMITED (Bangladesh) — jersey school wear", "QUATTRO FASHION LIMITED (Bangladesh) — woven school shirts"],
