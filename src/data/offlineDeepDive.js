...
const BRAND_PROFILES = {
  ...
  sainsburys: {
    ...
    // Ordering: BD(34%) → CN(26%) → TR(14%) → KH(10%) → IN(7%) → LK(4%) → PK(3%) → VN(2%) → EG(1%)
    // Babylon = confirmed SJ MENSWEAR supplier (woven shirts); Paramount = confirmed SJ WOMENSWEAR (dresses/blouses)
    // SQ Birichina = lingerie/activewear/swimwear specialist; QUATTRO FASHION = woven shirts (men's & ladies')
    // AMAN KNITTINGS = full-fashion sweaters/pullovers (NOT T-shirts); Jiangyin Chaoyu = socks only (NOT knitwear)
    // BONY TEKSTIL = socks specialist (NOT coats); Indochine Cambodia = woven shirts/blouses (NOT activewear)
    vendors: [
      "Babylon Garments Ltd (Bangladesh, Mirpur) — menswear woven shirts, confirmed SJ",
      "Echotex Ltd (Bangladesh, Kaliakair) — all-gender jersey knitwear",
      "SOUTH EAST TEXTILES (PVT.) LIMITED (Bangladesh, Gazipur) — jersey composite kids/men/women",
      "Kenpark Bangladesh Apparel Pvt. Ltd. (K-3) (Bangladesh, Chittagong) — woven bottoms & jackets",
      "SQ Birichina Limited (Bangladesh, Bhaluka) — lingerie/activewear/swimwear",
      "QUATTRO FASHION LIMITED (Bangladesh, Gazipur) — woven shirts",
      "Hangzhou Yukai Garments Co Ltd (China, Hangzhou) — sweaters/knitwear accessories",
      "Ugur Konfeksiyon San. Ve Tic. A.S. (Türkiye, Bayrampasa) — woven casualwear/shirts",
      "Indochine Apparel (Cambodia) Ltd (Cambodia) — woven shirts/blouses",
      "Paramount Garments Pvt. Ltd. (India, Okhla) — womenswear dresses/blouses, confirmed SJ",
      "Quantum Knits Pvt. Ltd. (India, Coimbatore) — schoolwear polos & jersey knits, confirmed SJ",
      "Hirdaramani Clothing (Private) Limited (Sri Lanka) — outerwear/swimwear/loungewear"
    ],
    vendorsByCategory: {
      "Dresses":                ["Babylon Garments Ltd (Bangladesh) — woven ladies' dresses, confirmed SJ", "SM Knitwear Ltd (Bangladesh) — maxi dresses (jersey)", "Era Tekstil Sanayi Ve Ticaret A.S. (Türkiye) — circular knitwear dresses", "Paramount Garments Pvt. Ltd. (India, Okhla) — ladies woven dresses, confirmed SJ", "Afflatus Clothing Pvt. Ltd. (India, Manesar)"],
      "Jeans":                  ["Kenpark Bangladesh Apparel Pvt. Ltd. (K-3) (Bangladesh) — woven bottoms/jeans", "QUATTRO FASHION LIMITED (Bangladesh) — woven trousers/bottoms", "Ugur Konfeksiyon San. Ve Tic. A.S. (Türkiye) — woven casualwear"],
      "Hoodies & Sweatshirts":  ["Echotex Ltd (Bangladesh) — all-gender jersey hoodies", "SM Knitwear Ltd (Bangladesh) — sweatshirts/hoodies", "SOUTH EAST TEXTILES (PVT.) LIMITED (Bangladesh) — jersey hoodies kids/men/women", "AKADEMI TEKSTIL SANAYI VE TICARET A.S. (Türkiye) — fashion knitwear"],
      "Tops & T-Shirts":        ["Echotex Ltd (Bangladesh) — all-gender jersey tops/tees", "SOUTH EAST TEXTILES (PVT.) LIMITED (Bangladesh) — jersey tops kids/men/women", "SM Knitwear Ltd (Bangladesh) — T-shirts/tank tops", "Era Tekstil Sanayi Ve Ticaret A.S. (Türkiye) — circular knit tops"],
      "Activewear":             ["SQ Birichina Limited (Bangladesh) — activewear specialist, LEED Platinum", "Echotex Ltd (Bangladesh) — jersey activewear", "Era Tekstil Sanayi Ve Ticaret A.S. (Türkiye) — knit leggings/active tops", "Liz Fashion Industry Ltd (Bangladesh) — sportswear"],
      "School Uniform":         ["Echotex Ltd (Bangladesh) — jersey school polos/sweatshirts", "Kenpark Bangladesh Apparel Pvt. Ltd. (K-3) (Bangladesh) — woven school shirts/trousers", "SOUTH EAST TEXTILES (PVT.) LIMITED (Bangladesh) — jersey school wear", "QUATTRO FASHION LIMITED (Bangladesh) — woven school shirts", "Quantum Knits Pvt. Ltd. (India, Coimbatore) — schoolwear polos, confirmed SJ"],
      "Coats & Jackets":        ["Kenpark Bangladesh Apparel Pvt. Ltd. (K-3) (Bangladesh) — casual woven jackets", "Hirdaramani Clothing (Private) Limited (Sri Lanka) — outerwear", "Hirdaramani Industries (Private) Limited (Sri Lanka) — jackets/outerwear"],
      ...
      "Knitwear & Jumpers":     ["AMAN KNITTINGS LTD (Bangladesh, Savar) — hand-flat knit sweaters (2,000 machines)", "Indesore Sweater Ltd (Bangladesh) — sweaters/pullovers/cardigans", "SQ CELSIUS LIMITED (Bangladesh) — full-fashion knitwear", "Agile Sweater (Cambodia) Co Ltd (Cambodia) — full-fashion sweaters", "Hangzhou Yukai Garments Co Ltd (China) — sweaters/scarves/shawls", "Ningbo Seduno Knitting Co (China) — cardigans/pullovers"],
      "Pyjamas & Nightwear":    ["Era Tekstil Sanayi Ve Ticaret A.S. (Türkiye) — PJ sets, nightwear", "Ningbo Seduno Knitting Co (China) — sleepwear/knitwear basics", "Paramount Garments Pvt. Ltd. (India, Okhla) — ladies nightwear, confirmed SJ"],
      ...
      "Sleepsuits & Bodysuits": ["Echotex Ltd (Bangladesh) — jersey bodysuits/babywear", "SOUTH EAST TEXTILES (PVT.) LIMITED (Bangladesh) — jersey babywear/bodysuits", "SM Knitwear Ltd (Bangladesh) — toddler/babies knitwear", "Ningbo Seduno Knitting Co (China) — knitwear basics"],
      "Rompers & Outfits":      ["Echotex Ltd (Bangladesh) — jersey baby rompers/outfits", "SOUTH EAST TEXTILES (PVT.) LIMITED (Bangladesh) — jersey babywear/rompers, kids", "SM Knitwear Ltd (Bangladesh) — baby knit rompers/sets", "Quantum Knits Pvt. Ltd. (India, Coimbatore) — baby jersey knits"],
      "Baby":                   ["Echotex Ltd (Bangladesh) — jersey baby garments", "SOUTH EAST TEXTILES (PVT.) LIMITED (Bangladesh) — jersey babywear, all items", "SM Knitwear Ltd (Bangladesh) — baby knitwear", "Quantum Knits Pvt. Ltd. (India, Coimbatore) — baby jersey knits"],
      "Lingerie & Intimates":   ["SQ Birichina Limited (Bangladesh) — lingerie specialist, LEED Platinum", "Hirdaramani Clothing (Private) Limited (Sri Lanka) — loungewear/intimates", "Penti Corap San. ve Tic. A.S. (Türkiye) — intimates/legwear"],
      ...
      "Chinos & Trousers":      ["Kenpark Bangladesh Apparel Pvt. Ltd. (K-3) (Bangladesh) — woven bottoms/chinos", "QUATTRO FASHION LIMITED (Bangladesh) — woven bottoms", "Ugur Konfeksiyon San. Ve Tic. A.S. (Türkiye) — woven trousers"],
      "Eveningwear":            ["Babylon Garments Ltd (Bangladesh) — ladies' woven dresses, confirmed SJ", "Era Tekstil Sanayi Ve Ticaret A.S. (Türkiye) — knitwear occasion dresses", "Paramount Garments Pvt. Ltd. (India, Okhla) — ladies occasion dresses"],
      "Blouses & Tops":         ["Babylon Garments Ltd (Bangladesh) — ladies' blouses, confirmed SJ", "Indochine Apparel (Cambodia) Ltd (Cambodia) — woven blouses/shirts", "Era Tekstil Sanayi Ve Ticaret A.S. (Türkiye) — knit tops", "Paramount Garments Pvt. Ltd. (India, Okhla) — ladies blouses/tops", "Afflatus Clothing Pvt. Ltd. (India, Manesar)"],
      ...
      "Casual Shirts":          ["QUATTRO FASHION LIMITED (Bangladesh) — woven casual shirts, men's & ladies'", "Babylon Garments Ltd (Bangladesh) — men's woven casual shirts, confirmed SJ", "Indochine Apparel (Cambodia) Ltd (Cambodia) — woven shirts/casual tops", "Ugur Konfeksiyon San. Ve Tic. A.S. (Türkiye) — woven casual shirts"],
      "Socks & Hosiery":        ["BONY TEKSTIL ISLETMELERI VE SAN. TIC. A.S. (Türkiye) — 100M pairs/yr socks", "NBG Corap Imalati San. ve Tic. A.S. (Türkiye) — GOTS certified hosiery", "Murat Corap San. Tic. A.S. (Türkiye) — 40M pairs/yr hosiery", "Jiangyin Chaoyu Knitting Co (China) — sublimation print socks"],
    },
