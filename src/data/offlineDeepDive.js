...
const BRAND_PROFILES = {
  ...
  sainsburys: {
    ...
    vendorsByCategory: {
      ...
      "Rompers & Outfits":      ["AKH Knitting and Dyeing Ltd (Bangladesh) — confirmed SJ babywear supplier", "New Harvest (China) — confirmed SJ baby knitwear", "Jay Jay Mills (Sri Lanka) — confirmed SJ baby jersey knits", "Poppy's Knitwear — confirmed SJ babywear"],
      "Baby":                   ["AKH Knitting and Dyeing Ltd (Bangladesh) — confirmed SJ babywear supplier", "New Harvest (China) — confirmed SJ baby knitwear", "Jay Jay Mills (Sri Lanka) — confirmed SJ baby jersey knits", "Poppy's Knitwear — confirmed SJ babywear"],
