...
const VERIFIED_VENDORS = {
  ...
  "sainsbury's tu": {
    ...
    //         Key anchors: Babylon Garments (confirmed SJ woven), Echotex (jersey knitwear), Kenpark K-3 (woven bottoms/jackets)
    //         Paramount Okhla (confirmed SJ womenswear), QUATTRO FASHION (woven shirts), Era Tekstil (circular knitwear)
    ...
    default:                 ["Babylon Garments Ltd (Bangladesh, Mirpur) — confirmed SJ woven shirts/blouses/dresses", "Echotex Ltd (Bangladesh, Kaliakair) — jersey knitwear", "Kenpark Bangladesh Apparel Pvt. Ltd. (K-3) (Bangladesh, Chittagong) — woven bottoms & jackets", "Era Tekstil Sanayi Ve Ticaret A.S. (Türkiye, Izmir) — circular knitwear dresses/tops/PJs", "QUATTRO FASHION LIMITED (Bangladesh, Gazipur) — woven shirts", "Paramount Garments Pvt. Ltd. (India, Okhla) — confirmed SJ womenswear", "SM Knitwear Ltd (Bangladesh, Gazipur) — jersey tops/hoodies/toddlerwear"],
    "Dresses":               ["Babylon Garments Ltd (Bangladesh) — woven ladies' dresses, confirmed SJ", "Era Tekstil Sanayi Ve Ticaret A.S. (Türkiye) — circular knitwear dresses", "Paramount Garments Pvt. Ltd. (India, Okhla) — ladies woven dresses, confirmed SJ", "SM Knitwear Ltd (Bangladesh) — maxi dresses (jersey)", "Afflatus Clothing Pvt. Ltd. (India, Manesar) — womenswear dresses/skirts"],
    ...
    "Hoodies & Sweatshirts": ["Echotex Ltd (Bangladesh) — jersey hoodies/sweatshirts", "SM Knitwear Ltd (Bangladesh) — sweatshirts/hoodies", "AKADEMI TEKSTIL SANAYI VE TICARET A.S. (Türkiye) — fashion knitwear", "Afflatus Clothing Pvt. Ltd. (India, Manesar) — jersey hoodies"],
    "Tops & T-Shirts":       ["Echotex Ltd (Bangladesh) — jersey tops/tees", "SM Knitwear Ltd (Bangladesh) — T-shirts/tank tops", "Era Tekstil Sanayi Ve Ticaret A.S. (Türkiye) — circular knit tops", "AKADEMI TEKSTIL SANAYI VE TICARET A.S. (Türkiye) — fashion knit tops"],
    ...
    "School Uniform":        ["Kenpark Bangladesh Apparel Pvt. Ltd. (K-3) (Bangladesh) — woven school shirts/trousers", "Echotex Ltd (Bangladesh) — jersey polo shirts/sweatshirts", "QUATTRO FASHION LIMITED (Bangladesh) — woven school shirts"],
    ...
    "Formal Shirts":         ["QUATTRO FASHION LIMITED (Bangladesh) — woven formal shirts, men's & ladies'", "Babylon Garments Ltd (Bangladesh) — men's woven shirts, confirmed SJ", "Ugur Konfeksiyon San. Ve Tic. A.S. (Türkiye) — woven formal shirts"],
    ...
    "Pyjamas & Nightwear":   ["Era Tekstil Sanayi Ve Ticaret A.S. (Türkiye) — PJ sets, nightwear", "Paramount Garments Pvt. Ltd. (India, Okhla) — ladies nightwear/beachwear, confirmed SJ", "Ningbo Seduno Knitting Co (China) — sleepwear/knitwear basics"],
    ...
    "Sleepsuits & Bodysuits":["Echotex Ltd (Bangladesh) — jersey bodysuits/babywear", "SM Knitwear Ltd (Bangladesh) — toddler/babies knitwear", "Ningbo Seduno Knitting Co (China) — knitwear basics/underwear"],
    ...
    "Eveningwear":           ["Babylon Garments Ltd (Bangladesh) — ladies' woven dresses/blouses", "Era Tekstil Sanayi Ve Ticaret A.S. (Türkiye) — knitwear dresses", "Paramount Garments Pvt. Ltd. (India, Okhla) — ladies occasion dresses"],
    "Blouses & Tops":        ["Babylon Garments Ltd (Bangladesh) — ladies' blouses, confirmed SJ", "Paramount Garments Pvt. Ltd. (India, Okhla) — ladies blouses/tops", "Afflatus Clothing Pvt. Ltd. (India, Manesar) — womenswear blouses/tops", "Era Tekstil Sanayi Ve Ticaret A.S. (Türkiye) — knit tops", "Indochine Apparel (Cambodia) Ltd (Cambodia) — woven blouses/shirts"],
    "T-Shirts & Polos":      ["Echotex Ltd (Bangladesh) — jersey T-shirts/polos", "SM Knitwear Ltd (Bangladesh) — T-shirts/polos", "AKADEMI TEKSTIL SANAYI VE TICARET A.S. (Türkiye) — fashion knit tops"],
    "Casual Shirts":         ["QUATTRO FASHION LIMITED (Bangladesh) — woven casual shirts, men's & ladies'", "Babylon Garments Ltd (Bangladesh) — men's casual shirts, confirmed SJ", "Ugur Konfeksiyon San. Ve Tic. A.S. (Türkiye) — woven casual shirts", "Indochine Apparel (Cambodia) Ltd (Cambodia) — woven shirts/casual tops"],
