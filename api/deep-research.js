...
const VERIFIED_VENDORS = {
  ...
  "sainsbury's tu": {
    ...
    "Rompers & Outfits":     ["Echotex Ltd (Bangladesh) — jersey baby rompers/outfits", "SOUTH EAST TEXTILES (PVT.) LIMITED (Bangladesh) — jersey babywear/rompers, kids", "SM Knitwear Ltd (Bangladesh) — baby knit rompers/sets", "Quantum Knits Pvt. Ltd. (India, Coimbatore) — baby jersey knits, confirmed SJ"],
    "Baby":                  ["Echotex Ltd (Bangladesh) — jersey baby garments (all types)", "SOUTH EAST TEXTILES (PVT.) LIMITED (Bangladesh) — jersey babywear composite", "SM Knitwear Ltd (Bangladesh) — baby knitwear", "Quantum Knits Pvt. Ltd. (India, Coimbatore) — baby jersey knits, confirmed SJ"],
